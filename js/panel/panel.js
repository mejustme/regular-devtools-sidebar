$(function () {
    ...
    MyApp.init = function () {
        ...
        MyApp.socket.on('onNpmTasksLoaded', function (data) {
            if (MyApp.currentView) {
                MyApp.currentView.close();
            }
        ...
        MyApp.socket.on('onTaskRunning', function (data) {
            if (!MyApp.context) {
        ...
        MyApp.socket.on('onTaskFinish', function (data) {
            if (!MyApp.context) {
                throw "application controller is not defined";
            }
        ...
        MyApp.socket.on('onTaskExit', function (data) {
            if (!MyApp.context) {
                throw "application controller is not defined";
            }
            MyApp.context.dispatch(MyApp.AppEvents.ON_TASK_FINISHED, data);
